                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {/* Account Registration / Guest Badge */}
                        {fb.isRegisteredUser ? (
                          <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-emerald-100 text-emerald-800 border border-emerald-300 flex items-center gap-1">
                            ...
                            <span>VERIFIED ({fb.userRole || 'USER'})</span>
                          </span>
                        ) : (
                      ...
                      {/* Attached Verified Profile (preserved even if sender erased input fields) */}
                      {fb.senderProfile && (
                        <div className="text-[11px] text-emerald-900 bg-emerald-50/80 border border-emerald-200 rounded-lg px-2.5 py-1 inline-flex items-center gap-1.5 font-medium">
                          <ShieldCheck className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
                          <span><strong>Verified Profile:</strong> {fb.senderProfile}</span>
                        </div>
                      )}
